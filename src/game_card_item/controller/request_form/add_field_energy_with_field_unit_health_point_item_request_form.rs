...
impl AddFieldEnergyWithFieldUnitHealthPointRequestForm {
    ...
    pub fn to_is_it_item_card_request(
        &self,
        item_card_id: i32) -> IsItItemCardRequest {

        IsItItemCardRequest::new(
            item_card_id)
    }
    ...
    pub fn to_summary_item_effect_request(
        &self,
        item_card_id: i32) -> SummaryItemCardEffectRequest {

        SummaryItemCardEffectRequest::new(
            item_card_id)
    }

    pub fn to_use_game_hand_item_card_request(
        &self,
        account_unique_id: i32,
    ...
    pub fn to_get_field_unit_health_point_request(
        &self,
        account_unique_id: i32,
    ...
    pub fn to_apply_instant_death_to_target_unit_index_request(
        ...
        opponent_target_unit_index: i32) -> ApplyInstantDeathToTargetUnitIndexRequest {
    ...
    pub fn to_add_field_energy_with_amount_request(
        &self,
        account_unique_id: i32,
        amount_to_add: i32) -> AddFieldEnergyWithAmountRequest {
    ...
    pub fn to_generate_use_my_hand_card_data_request(
        &self,
        used_hand_card_id: i32) -> GenerateUseMyHandCardDataRequest {
    ...
    pub fn to_generate_my_specific_field_unit_death_data_request(
        &self,
