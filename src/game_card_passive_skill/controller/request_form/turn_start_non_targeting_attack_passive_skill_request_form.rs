...
impl TurnStartNonTargetingAttackPassiveSkillRequestForm {
    ...
    pub fn to_notice_turn_start_non_targeting_attack_passive_skill_request(
        &self,
        opponent_unique_id: i32,
    ...
    ) -> NoticeTurnStartNonTargetingAttackPassiveSkillRequest {

        NoticeTurnStartNonTargetingAttackPassiveSkillRequest::new(
            opponent_unique_id,
