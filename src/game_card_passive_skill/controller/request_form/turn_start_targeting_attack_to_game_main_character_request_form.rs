...
pub struct TurnStartTargetingAttackToGameMainCharacterRequestForm {
    session_id: String,
...
impl TurnStartTargetingAttackToGameMainCharacterRequestForm {
    ...
    pub fn to_notice_turn_start_targeting_attack_to_game_main_character_request(
        &self,
        ...
        NoticeTurnStartTargetingAttackToGameMainCharacterRequest::new(
            opponent_unique_id,
