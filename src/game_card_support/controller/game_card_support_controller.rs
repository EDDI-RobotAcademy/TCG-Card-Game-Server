...
pub trait GameCardSupportController {
    ...
    async fn check_search_unit_support_available(&self, check_search_unit_support_available_request_form: CheckSearchUnitSupportAvailableRequestForm) -> CheckSearchUnitSupportAvailableResponseForm;
