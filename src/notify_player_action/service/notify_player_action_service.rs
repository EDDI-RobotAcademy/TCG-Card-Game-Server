...
pub trait NotifyPlayerActionService {
    ...
    async fn notify_opponent_you_execute_instant_death_of_field_unit(&mut self, notify_to_opponent_you_use_item_card_request: NotifyToOpponentYouUseItemInstantDeathRequest) -> NotifyToOpponentYouUseItemCardResponse;
