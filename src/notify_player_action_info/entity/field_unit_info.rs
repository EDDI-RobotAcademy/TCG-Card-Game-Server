...
use crate::notify_player_action_info::entity::attached_energy_map_info::AttachedEnergyMapInfo;
...
pub struct FieldUnitInfo {
    attached_energy: AttachedEnergyMapInfo,
...
impl FieldUnitInfo {
    pub fn new(attached_energy: AttachedEnergyMapInfo,
               extra_effect: ExtraEffectInfo,
               harmful_status: HarmfulStatusInfo,
               attack_point: i32,
               health_point: i32,
