...
pub struct NotifyFormTurnStartTargetingAttackToGameMainCharacter {
...
impl NotifyFormTurnStartTargetingAttackToGameMainCharacter {
    pub fn new(
        player_main_character_health_point_map: HashMap<PlayerIndex, i32>,
        player_main_character_survival_map: HashMap<PlayerIndex, StatusMainCharacterEnum>,
    ) -> Self {

        NotifyFormTurnStartTargetingAttackToGameMainCharacter {
