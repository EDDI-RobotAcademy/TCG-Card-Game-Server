#[derive(Debug)]
pub struct NoticeInstantDeathOfSpecificOpponentUnitRequest {
    opponent_unique_id: i32,
    dead_unit_index: i32,
}

impl NoticeInstantDeathOfSpecificOpponentUnitRequest {
    pub fn new(opponent_unique_id: i32,
               dead_unit_index: i32,) -> Self {
        NoticeInstantDeathOfSpecificOpponentUnitRequest {
            opponent_unique_id,
            dead_unit_index,
        }
    }
